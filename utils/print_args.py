"""
Argument printing utility for experiment configurations.

This module provides a function to pretty-print experiment configuration
arguments in a structured, categorized format with ANSI color codes.
"""

def print_args(args):
    """
    Print experiment configuration arguments in a formatted, categorized layout.
    
    This function organizes and displays all experiment configuration parameters
    in a human-readable format, grouped by category with bold headers.
    It uses ANSI escape codes for bold text formatting.
